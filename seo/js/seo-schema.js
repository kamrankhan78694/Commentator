...
class SEOSchemaManager {
    ...
    getUniversalSchema() {
        ...
        return [
            ...
            // WebSite Schema
            {
                ...
                "@type": "WebSite",
                "name": "Commentator",
                "description": "A disruptive, open-source platform for universal web commentary. Liberating the web through decentralized, community-driven feedback.",
                "url": baseUrl,
                "potentialAction": {
                    "@type": "SearchAction",
                    "target": {
        ...
        switch (pageType) {
            ...
            case 'software':
                schema = {
                    ...
                    "description": schemaData.description || "Universal Web Comments Platform",
                    "url": currentUrl,
                    "applicationCategory": "Social Media Application",
                    "operatingSystem": "Web Browser",
    ...
    injectSchemas() {
        ...
        const existingSchemas = document.querySelectorAll('script[type="application/ld+json"][data-schema-manager]');
    ...
    removeAllSchemas() {
        ...
        const schemas = document.querySelectorAll('script[type="application/ld+json"][data-schema-manager]');
